...
if "%~1" == "nuitka" (
    ...
    venv\Scripts\python.exe -m nuitka --standalone --onefile --windows-console-mode=disable --plugin-enable=pyside6 --windows-icon-from-ico=.\img\king.ico BoardMaster.py
    goto :build_complete
)
